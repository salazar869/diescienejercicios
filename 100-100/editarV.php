...
if($nlinea){
	...
	$registro = "SELECT * FROM vuelos WHERE IDvuelos = $nlinea;";
...
<body>
    ...
    <div class="contenido">
    <form class="contact" action="actualizarV.php" method='post'>
            ...
            <input type="datetime-local" id="i2" name="c2" value="<?php echo $linea[3];?>">
            <br>
