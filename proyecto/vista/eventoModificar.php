...
while ($fila = mysqli_fetch_array($result)) {
    ...
    if ($fila != NULL) {
        ...
        $descripcionEvento = $fila['descripcionEvento'];
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h3 class="text-white font-weight-bold">Modificar Evento</h3>
                        <hr class="divider" />
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <form action="../controlador/editarEventoControlador.php" method='post' data-sb-form-api-token="API_TOKEN" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <!-- NOMBRE EVENTO-->
                            <div class="form-floating mb-3">
                                <input class="form-control" type="text" name="nombreEvento" value="<?php echo $nombreEvento; ?>" placeholder="Ingrese Nombre del Evento" data-sb-validations="required" />
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" type="text" name="descripcionEvento" value="<?php echo $descripcionEvento; ?>" placeholder="Ingrese descripción del evento" style="height: 10rem" data-sb-validations="required"></textarea>
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" name="fecha" value="<?php echo $fechaEvento; ?>" type="date" placeholder="Ingrese fecha del evento"  data-sb-validations="required">
                            ...
                            <div style="margin-bottom: 80px;">
                             <div class = "form-group">
                                 <img src="<?php echo $foto; ?>" class="rounded float-left" width="80" height="80" >                                    
                                    <input type = "file" name = "foto" id = "" required class="btn btn-light btn-circle btn-sm"  title="Modificar">                                    
                                </div>
                                </div>
